...
DO_WHILE_LOOP_3400
    ...
    BRnp CHECK_CASE_SENSITIVE	;if register 4 is negative or positive, it is not a palindrome and finish the loop
...
PALINDROME
    LEA R0, PALINDROME_MESSAGE_3400
    TRAP x22
    LEA R0, NEWLINE_3400
    TRAP x22
...
NOT_A_PALINDROME
    LEA R0, NOT_PALINDROME_MESSAGE_3400
    TRAP x22
    LEA R0, NEWLINE_3400
    TRAP x22
...
ALL_DONE_3400
	...
	ZERO_3400			            .FILL	#0
    PALINDROME_MESSAGE_3400         .STRINGZ    "CONGRATS! PALINDROME!"
    NOT_PALINDROME_MESSAGE_3400     .STRINGZ    "SORRY! TRY AGAIN."
